...
class Source_Data(object):
    ...
    def save_screeners_and_tickers(self):
        ...
        try:
            ...
            self.list_of_tickers.append(list(self.get_day_gainers["Symbol"]),)

            self.get_day_losers = si.get_day_losers()
            self.list_of_tickers.append(list(self.get_day_losers["Symbol"]),)

            self.get_day_most_active = si.get_day_most_active()
            self.list_of_tickers.append(list(self.get_day_most_active["Symbol"]),)

            self.get_trending_tickers = si.get_trending_tickers()
            self.list_of_tickers.append(list(self.get_trending_tickers["Symbol"]),)

            self.get_most_shorted_stocks = si.get_most_shorted_stocks()
            self.list_of_tickers.append(list(self.get_most_shorted_stocks["Symbol"]),)
            ...
            self.list_of_tickers.append(list(self.get_aggressive_small_caps["Symbol"]),)

            self.get_small_cap_gainers = si.get_small_cap_gainers()
            self.list_of_tickers.append(list(self.get_small_cap_gainers["Symbol"]),)

            self.get_top_crypto = si.get_top_crypto()
            self.list_of_tickers.append(list(self.get_top_crypto["Symbol"]),)

            self.get_top_mutual_funds = si.get_top_mutual_funds()
            self.list_of_tickers.append(list(self.get_top_mutual_funds["Symbol"]),)

            self.get_portfolio_anchors = si.get_portfolio_anchors()
            self.list_of_tickers.append(list(self.get_portfolio_anchors["Symbol"]),)
            ...
            self.list_of_tickers.append(list(self.get_high_yield_bond["Symbol"]),)
