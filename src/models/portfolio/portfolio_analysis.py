...
class Analize_Portfolio(object):
    ...
    def situation(self):
        ...
        st.write("* Presenting The Covariance Matrix For This Portfolio:")
        ...
        st.write(f"  >Mean Simulated Portfolio Mean Returns == {(np.mean(sharpe_indices))} ")
        st.write(f"\n  > Portfolio:")
        st.dataframe(df)


if __name__ == '__main__':
    stocks = ['TSLA', 'AMZN', 'AAPL','FB','NFLX','GOOGL']
    Analize_Portfolio(stocks).situation()