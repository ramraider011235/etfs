...
class The_OverBought_OverSold(object):
    ...
    def generate(self, df):
        ...
        ax2.bar(
            dates[pos], volume[pos], color="green", width=1, align="center", alpha=0.34
        )
        ax2.bar(
            dates[neg], volume[neg], color="red", width=1, align="center", alpha=0.34
        )
        ...
        candlestick_ohlc(
            ax2, noise_candlesticks, width=1, colorup="g", colordown="r", alpha=0.75
        )
